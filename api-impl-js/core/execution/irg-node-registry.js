...
const nodeRegistry = {
  ...
  nodes: {
    ...
    citationFetch: citationFetchNode,
    citationVerify: citationVerifyNode,
    memoryRecall: memoryRecallNode,
    caseRecall: caseRecallNode,
    classifyCase: classifyCaseNode,
    impact: impactNode,
    draft: draftNode,
    citationApply: citationApplyNode,
    citationQuality: citationQualityNode,
